      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _statItem(icon: Icons.timer_rounded, value: _formatMinutes(totalMinutes), label: 'Tempo total'),
              _statItem(icon: Icons.fitness_center_rounded, value: '$totalActivities', label: 'Atividades'),
              _statItem(
