...
class FlowDistributionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DashboardGlassCard(
      title: l10n.cardFlowDistribution,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(DomainTranslations.flow(context, entry.key), style: GoogleFonts.lato(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.grey[700])),
